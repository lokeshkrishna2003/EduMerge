...
const HeroSection = () => {
  ...
  <Link to="/explore" className="inline-block px-6 py-3 bg-violet-600 text-white font-semibold rounded hover:bg-violet-700 transition duration-500 ease-in-out animate-pop-in hover:animate-wiggle">
    Begin Your Journey
  </Link>
</div>
