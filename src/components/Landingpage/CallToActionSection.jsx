  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 to-black text-white py-12">
      <div className="container mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <Link to="/auth?mode=signup" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1" data-aos="zoom-in" data-aos-delay="400">
          Sign Up Now
        </Link>
      </div>
    </div>
