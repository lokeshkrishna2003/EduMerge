      ...
      <div className="p-10 rounded-lg shadow-xl max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="group relative border-b-2 border-gray-300 focus-within:border-purple-500">
            <FaUser className="absolute left-0 top-3 text-gray-400 group-focus-within:text-purple-500" />
            <input
              type="text"
              name="username"
          ...
          <div className="group relative border-b-2 border-gray-300 focus-within:border-purple-500">
            <FaEnvelope className="absolute left-0 top-3 text-gray-400 group-focus-within:text-purple-500" />
            <input
              type="email"
              name="email"
